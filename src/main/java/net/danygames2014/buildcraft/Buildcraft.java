...
import net.danygames2014.buildcraft.block.entity.pipe.behavior.GoldenPipeBehavior;
import net.danygames2014.buildcraft.block.entity.pipe.behavior.StonePipeBehavior;
import net.danygames2014.buildcraft.block.entity.pipe.behavior.WoodenPipeBehavior;
...
public class Buildcraft {
    ...
    public void registerBlocks(BlockRegistryEvent event) {
        ...
        landMarker = new LandMarkerBlock(NAMESPACE.id("land_marker"), Material.PISTON_BREAKABLE).setTranslationKey(NAMESPACE, "land_marker").setHardness(0.0F);
        pathMarker = new PathMarkerBlock(NAMESPACE.id("path_marker"), Material.PISTON_BREAKABLE).setTranslationKey(NAMESPACE, "path_marker").setHardness(0.0F);
